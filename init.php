...
NV_Admin_Settings::init();

/**
 * Contains functions that
 */
class NV_Admin_Settings {
    ...
    public static function settings_api() {
        ...
        // 2. Create a setting "section" (if not using an existing section)
        //add_settings_section($id, $title, $callback, $page);

        // 3. Add a visible HTML control/field to the section
